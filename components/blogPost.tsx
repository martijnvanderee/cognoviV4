...
export const BlogPost = ({ blogPost }: any) => {
  ...
  return (
    <Link
      href={`/blog/${urlLink}`}
      as={`/blog/${urlLink}`}
      className="flex md:block bg-white cursor-pointer rounded h-32 md:h-auto shadow-offset hover:shadow-offsetHover rounded transition duration-500 ease-in-out"
    >
