  ...
  return (
    <div className="flex py-6 px-4 border-b border-t border-almostWhite">
      <div className="w-full">
        ...
        >
          <input
            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 py-3 "
            id="instantie"
            type="text"
            placeholder="zoek op trefwoord,titel of auteur"
            name="instantie"
          />
        </label>
      </div>
