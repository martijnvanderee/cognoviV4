...
const Pagination1: FunctionComponent<PaginationProps1> = ({
  current,
  total,
  subject,
}) => {
          ...
          >
            ...
            {current > 2 && (
              <Link
                ...
                aria-current="page"
                className={`z-10   bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium`}
              >
                1
              </Link>
            )}
              ...
              return (
                <Link
                  href={{
                    ...
                    query: {
                      subject: subject,
                      slug: paginationNumber.toString(),
                    },
                  }}
                  className={` ${current === paginationNumber ? hover : notHover}  relative inline-flex items-center px-4 py-2 border text-sm font-medium`}
                >
                  {paginationNumber}
                </Link>
              );
