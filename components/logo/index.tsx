  ...
  return (
    <>
      ...
      <div className="flex">
        <Link
          href="/"
          className="my-auto focus:outline-none focus:ring focus:border-blue-300"
        >
        ...
        <Link
          href="/"
          passHref
          className="ml-2 focus:outline-none focus:ring focus:border-blue-300 hidden md:block"
        >
          <img
            style={{ minWidth: '34px' }}
